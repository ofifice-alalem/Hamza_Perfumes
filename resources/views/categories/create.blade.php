...
<div class="flex justify-between items-center mb-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 mb-2">
            <i class="fas fa-tags mr-3 text-blue-600"></i>إضافة تصنيف جديد
        </h2>
        <p class="text-gray-600">إضافة تصنيف جديد للعطور</p>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
            <h5 class="text-lg font-bold">
                <i class="fas fa-tags mr-3"></i>بيانات التصنيف الجديد
            </h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('categories.store') }}">
                ...
                <div class="flex gap-3">
                    <button type="submit" class="flex-1 btn-success">
                        <i class="fas fa-save mr-3"></i>حفظ التصنيف
                    </button>
